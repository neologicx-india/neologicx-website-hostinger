    ...
    <footer className="bg-muted/30 border-t border-border pt-16 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          {/* Company Info - Takes up 5 columns on desktop */}
          <div className="md:col-span-5 flex flex-col items-start">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <a href="mailto:contact@neologicx.com" className="hover:text-primary transition-colors">
              ...
              {socials.map((s, idx) => {
                ...
                return (
                  <a
                    key={idx}
                    href={s.href}
                    className="w-9 h-9 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors"
                  >
