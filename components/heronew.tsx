...
const INK = "#0E2A47";       // blueprint base
const INK_DEEP = "#0A1F35";  // panel shade
const LINE = "rgba(234,242,250,0.16)";  // linework
const LINE_STRONG = "rgba(234,242,250,0.32)";
const PAPER = "#F5F8FB";     // near-white text
const MUTED = "#8FA9C2";     // muted blue-grey
const SIGNAL = "#FF6A3D";    // safety-orange accent
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ background: `radial-gradient(ellipse at 30% 20%, transparent 0%, ${INK} 78%)` }}
            />
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <span className="hidden sm:flex items-center gap-2 text-[11px] tracking-[0.25em] uppercase" style={{ color: MUTED }}>
                        <span className="relative flex h-1.5 w-1.5">
                            <span className="absolute inline-flex h-full w-full rounded-full animate-ping" style={{ backgroundColor: SIGNAL, opacity: 0.6 }} />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[480px]">
                                        ...
                                        {activeIndex === index && (
                                            ...
                                            >
                                                ...
                                                <h1
                                                    ...
                                                    style={{ color: PAPER, fontFamily: "var(--font-display, sans-serif)" }}
                                                >
                                                    {slide.title}
                                                </h1>
                                ...
                                <div className="order-1 lg:order-2 w-full h-full min-h-[340px] lg:min-h-[480px] relative">
                                    <div
                                        ...
                                        style={{ border: `1px solid ${LINE_STRONG}`, backgroundColor: INK_DEEP }}
                                    >
                                        <AnimatePresence mode="wait">
                                            {activeIndex === index && (
                                                <motion.div
              ...
              sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                                                    ...
                                                    <div
                                                        ...
                                                        style={{ background: `linear-gradient(180deg, ${INK}00 55%, ${INK} 100%)` }}
                                                    />
                                                </motion.div>
                                            )}
                                        </AnimatePresence>
